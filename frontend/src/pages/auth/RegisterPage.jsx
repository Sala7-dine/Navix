        ...
        <div className="w-full h-screen flex overflow-hidden">
            ...
            <div className="w-1/2 wave-bg relative flex flex-col items-center justify-center text-white p-12" style={{ backgroundImage: `url(${camionBg})` }}>
                ...
                <div className="relative z-10 text-center">
                    <p className="text-lg font-light mb-4">Join our community</p>
                    <h1 className="text-5xl font-bold mb-8 leading-tight">CREATE ACCOUNT</h1>
                ...
                <div className="max-w-md w-full">
                    ...
                    <form className="space-y-4" onSubmit={handleSubmit}>
                        ...
                        <div className="flex items-center justify-between text-xs">
                            ...
                            <a href="/login" className="text-brand-pink hover:underline font-medium">
                                Already a member?
                            </a>
                        </div>
